 ...
 * @param {string} hostname - Original hostname that was resolved
 ...
 * @param {string} hostname - Original hostname that was resolved
 * @param {string[]} addresses - Array of resolved IP addresses
 * @returns {Object} - { allowed: boolean, reason?: string, filteredAddresses?: string[] }
 */
