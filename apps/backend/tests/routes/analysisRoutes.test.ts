...
describe('Analysis Routes - WITH REAL AUTH', () => {
  ...
  describe('Rate Limiting (Real Middleware)', () => {
    it('should include rate limit headers in responses', async () => {
      // Test that rate limiting headers are present (proves middleware is active)
      const viewerCookie = await getSessionCookie('teamViewer');
      ...
      // Rate limiter adds standard headers when enabled
      // These headers prove the rate limiter middleware is running
