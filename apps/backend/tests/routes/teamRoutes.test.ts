...
const TeamController: TeamControllerType = {
  getAllTeams: vi.fn((_req: Request, res: Response) =>
    res.json([
      { id: 'team-1', name: 'Team 1', color: '#FF0000', order: 0 },
      { id: 'team-2', name: 'Team 2', color: '#00FF00', order: 1 },
    ]),
  ),
  createTeam: vi.fn((req: Request, res: Response) =>
    res.status(201).json({
      id: 'new-team',
      name: req.body.name,
  ...
  reorderTeams: vi.fn((_req: Request, res: Response) =>
    res.json({ message: 'Teams reordered successfully' }),
  ),
  updateTeam: vi.fn((req: Request, res: Response) =>
    res.json({
      id: req.params.id,
      name: req.body.name,
      color: req.body.color,
  ...
  deleteTeam: vi.fn((_req: Request, res: Response) =>
    res.json({
      success: true,
  ...
  getTeamAnalysisCount: vi.fn((_req: Request, res: Response) =>
    res.json({ count: 5 }),
  ),
  moveAnalysisToTeam: vi.fn((req: Request, res: Response) =>
    res.json({
      success: true,
  ...
  createFolder: vi.fn((req: Request, res: Response) =>
    res.status(201).json({
      id: 'new-folder',
      name: req.body.name,
  ...
  updateFolder: vi.fn((req: Request, res: Response) =>
    res.json({
  ...
  deleteFolder: vi.fn((_req: Request, res: Response) =>
    res.json({
      success: true,
      message: 'Folder deleted successfully',
    }),
  ),
  moveItem: vi.fn((_req: Request, res: Response) =>
    res.json({
      success: true,
...
vi.mock('../../src/controllers/teamController.ts', () => ({
...
describe('Team Routes - WITH REAL AUTH', () => {
  ...
  beforeEach(async () => {
    ...
    // Import routes
    const { teamRouter } = await import('../../src/routes/teamRoutes.ts');
