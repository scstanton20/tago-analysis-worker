...
describe('analysisInfoService', () => {
  ...
  beforeEach(async () => {
    ...
    analysisService = analysisServiceModule.analysisService;

    const teamServiceModule = await import('../../src/services/teamService.js');
    teamService = teamServiceModule.teamService;

    safePath = await import('../../src/utils/safePath.js');

    // Import the service under test
    const module = await import('../../src/services/analysisInfoService.js');
    analysisInfoService = module.analysisInfoService;
  });
  ...
  describe('getAnalysisNotes', () => {
    ...
    it('should create default notes if file does not exist', async () => {
      ...
      safePath.safeWriteFile.mockResolvedValue();
