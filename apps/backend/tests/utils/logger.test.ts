...
describe('logger', () => {
  ...
  describe('parseLogLine', () => {
    it('should parse valid NDJSON log line as object', async () => {
      ...
      const result = parseLogLine(logLine, true) as LogParseResult;
    ...
    it('should parse log line as formatted string', async () => {
      ...
      const result = parseLogLine(logLine, false) as string;
  ...
  describe('environment configuration', () => {
    it('should use debug level in development', async () => {
      ...
      const logger = await import('../../src/utils/logging/logger.ts');
  ...
  describe('serializers', () => {
    ...
    it('should serialize error information', async () => {
      ...
      const testError = new Error('Test error') as Error & {
        code?: string;
        errno?: number;
        syscall?: string;
        path?: string;
  ...
  describe('multiple transports', () => {
    it('should configure both pretty print and Loki in development', async () => {
      ...
      try {
        ...
        expect((error as Error).message).toContain('custom level formatters');
      }
    });
