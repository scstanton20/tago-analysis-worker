...
describe('sseSchemas', () => {
  ...
  beforeEach(async () => {
    const module = await import('../../src/validation/sseSchemas.js');
    schemas = module.sseValidationSchemas;
  });
  ...
  describe('schema consistency', () => {
    ...
    it('should fail consistently for both schemas with invalid data', () => {
      ...
      const unsubscribeResult = schemas.unsubscribe.body.safeParse(invalidData);
